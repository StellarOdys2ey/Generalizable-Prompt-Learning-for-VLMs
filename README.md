...
- The layout of this list is inspired by the repository [[here](https://github.com/zhengli97/Awesome-Prompt-Adapter-Learning-for-VLMs)], which is initiated and maintained by **Zheng Li**. He is currently a third-year Ph.D. student at Nankai University, with one more CCF A-level paper to be published before graduation. I wish him success in his research and happy trail running.
